...
public class HomeController {
	...
	@RequestMapping("/user-xc")
	@ResponseBody
	public Principal user(Principal user) {
		return user;
	}
	
	@RequestMapping("/adminresource-xc")
	...
	@RequestMapping(value="/userresource-xc", method = RequestMethod.GET, produces = {MediaType.APPLICATION_JSON_VALUE})
